...
#define TS(n) Rule::Chain::T(n)
	...
	Greibach greibach(NS('S'), TS('$'), 16,
		Rule(NS('S'), GRB_ERROR_SERIES, 3,						
			...
			Rule::Chain(5, TS('p'), TS('i'), NS('P'), NS('G'), NS('S')),
		...
		Rule(NS('R'), GRB_ERROR_SERIES + 7, 2,					
			Rule::Chain(3, TS('n'), NS('Z'), NS('Y')),
			Rule::Chain(5, TS('n'), NS('Z'), NS('Y'), TS('e'), NS('Y'))
		),
		Rule(NS('Y'), GRB_ERROR_SERIES + 8, 1,						
			Rule::Chain(3, TS('{'), NS('X'), TS('}'))
		),
		Rule(NS('Z'), GRB_ERROR_SERIES + 9, 6,					
		...
		Rule(NS('Q'), GRB_ERROR_SERIES + 11, 4,					
			Rule::Chain(1, TS('+')),
			Rule::Chain(1, TS('-')),
			Rule::Chain(1, TS('*')),
			Rule::Chain(1, TS('/'))
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 14, 12,				
			Rule::Chain(7, TS('d'), TS('t'), TS('i'), TS('='), NS('W'), TS(';'), NS('K')),	
			Rule::Chain(5, TS('d'), TS('t'), TS('i'), TS(';'), NS('K')),	

			Rule::Chain(4, TS('s'), NS('V'), TS(';'), NS('K')),				
			Rule::Chain(3, TS('#'), NS('R'), NS('K')),	
			...
			Rule::Chain(3, TS('s'), NS('V'), TS(';')),		
			Rule::Chain(2, TS('#'), NS('R')),			
			Rule::Chain(3, TS('i'), NS('F'), TS(';'))		
		),
		Rule(NS('X'), GRB_ERROR_SERIES + 15, 6,				
			Rule::Chain(5, TS('i'), TS('='), NS('W'), TS(';'), NS('X')),
			Rule::Chain(4, TS('s'), NS('V'), TS(';'), NS('X')),			
